...
parser = argparse.ArgumentParser(description="DongFang Flight python script")
parser.add_argument("--timerange", default= 1, help="the month span", required=True)
